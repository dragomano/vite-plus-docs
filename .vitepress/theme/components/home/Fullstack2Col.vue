...
<template>
  ...
  >
    <div class="bg-beige/50 p-5 sm:p-10 flex flex-col gap-3 justify-between">
      ...
      <img loading="lazy" :src="metaFrameworksImage" alt="Мета-фреймворки" class="w-full mt-11" />
    </div>
    <div class="flex flex-col justify-between h-full">
      <div class="flex flex-col divide-y divide-stroke shrink-0">
        <div class="p-5 sm:p-10 flex flex-col gap-3">
          <h6>Независимость от платформы</h6>
          <p class="max-w-[18rem] text-balance">
      ...
      <div class="bg-nitro bg-right-top px-10 pt-7 flex flex-col justify-end gap-5 shrink-0">
        <div class="flex flex-row items-center gap-5">
          <img loading="lazy" :src="nitroIcon" alt="Иконка Nitro" class="size-10 sm:size-12" />
          <h6 class="text-white drop-shadow-sm/70">Развёртывайте где угодно в паре с Nitro</h6>
        </div>
        <img loading="lazy" :src="nitroTerminal" alt="Развёртывание где угодно с помощью Nitro" class="w-full" />
      </div>
    </div>
  </section>
</template>
