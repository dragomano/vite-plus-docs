  ...
  <section id="feature-pack" class="wrapper border-t grid md:grid-cols-2 md:divide-x divide-nickel">
    <div class="px-5 py-6 md:p-10 flex flex-col justify-between gap-15">
      <div class="flex flex-col gap-5">
        ...
        <h4 class="text-white">Упаковка библиотек с соблюдением лучших практик</h4>
        <p class="text-white/70 text-base max-w-[25rem] text-pretty">
          Упаковывайте TS и JS-библиотеки для npm или собирайте автономные бинарники приложений
          одной командой <code class="mx-1 outline-none bg-nickel/50 text-aqua">vp pack</code>.
        </p>
        <ul class="checkmark-list">
          <li>
            Генерация и сборка <code class="mx-1 outline-none bg-nickel/50 text-[#6CA1DB]">DTS</code>
          </li>
          <li>Автоматическая генерация точек экспорта пакета</li>
          <li>Автономные исполняемые файлы приложений и режим только с преобразованием без сборки в бандл</li>
        </ul>
      </div>
