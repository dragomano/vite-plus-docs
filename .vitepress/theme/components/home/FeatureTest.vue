  ...
  <section id="feature-test" class="wrapper border-t grid md:grid-cols-2 divide-x divide-nickel">
    <div class="px-5 py-6 md:p-10 flex flex-col justify-between gap-15">
      <div class="flex flex-col gap-5">
        ...
        <h4 class="text-white">Тестирование стало проще</h4>
        <p class="text-white/70 text-base max-w-[25rem] text-pretty">
          Богатый функционалом тестовый раннер, который автоматически использует те же настройки
          resolve и transform, что и ваше приложение.
        </p>
        <ul class="checkmark-list">
          <li><code class="mr-1 outline-none bg-nickel/50 text-zest">Jest</code>-совместимый API</li>
          <li>Изоляция тестов по умолчанию</li>
          <li>Режим браузера: запуск юнит-тестов в реальных браузерах</li>
          <li>Отчёты о покрытии, snapshot-тесты, type-тесты, визуальное регрессионное тестирование…</li>
        </ul>
      </div>
