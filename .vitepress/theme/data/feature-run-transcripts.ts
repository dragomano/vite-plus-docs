...
export const featureRunTranscripts: TerminalTranscript[] = [
  {
    ...
    lines: [
      {
        segments: [{ text: '# При первом запуске собираются общая библиотека и приложение', tone: 'muted' }],
      },
      {
  ...
  },
  {
    ...
    lines: [
      {
        segments: [{ text: '# При отсутствии изменений оба задания воспроизводятся из кэша', tone: 'muted' }],
      },
      {
        segments: [
  ...
  },
  {
    ...
    lines: [
      {
        segments: [{ text: '# При изменениях в приложении пересобирается только приложение', tone: 'muted' }],
      },
      {
        segments: [
          { text: '$ vp pack ', tone: 'muted' },
  ...
  },
  {
    ...
    lines: [
      {
        segments: [{ text: '# При изменениях в общем API пересобираются библиотека и приложение', tone: 'muted' }],
      },
      {
        segments: [
          { text: '$ vp pack ', tone: 'muted' },
