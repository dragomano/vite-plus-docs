...
Вместо этого Vite+ управляет собственными глобальными пакетами, которые хранятся в `~/.vite-plus/packages`. Благодаря этому они остаются доступными при переключении между разными версиями Node.js.
