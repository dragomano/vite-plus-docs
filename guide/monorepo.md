...
- Храните специфичные для пакета сценарии в самом пакете, если команды различаются между приложениями:
...
- Запускайте сценарии по всему рабочему пространству с помощью `vp run`:
