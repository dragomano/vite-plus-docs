...
## Тесты в режиме браузера (Vitest / Playwright) {#browser-mode-tests-vitest-playwright}
...
Если Chromium аварийно завершается под высокой нагрузкой в CI, выделите контейнеру больше общей памяти с помощью `--ipc=host`; см. [документацию Playwright по Docker](https://playwright.dev/docs/docker).
